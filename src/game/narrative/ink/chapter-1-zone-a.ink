...
第一张号票还在取号机口轻轻抖动。排队管理处退到胶带线后面；林小满的名单压住一角；章盒又自己往前滑了半寸。{protagonist_name}没有获得权力，只是被推到了责任最容易落下来的位置。现场工作台已经摆好：林小满、队伍、取号机、窗口桌面、熟客名单、手续边界，六处都能先点，但任何一处都会把压力带到别处。
