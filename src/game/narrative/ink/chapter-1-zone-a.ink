...
长昼把临时避难点晒得发白。折叠桌上分成四摞：配给回执、空白值班表、临时通行条复印申请、便利店临期酸奶清点表。第五样东西是周婶留下的空碗，它不属于任何材料，却比所有材料都更像证据。

排队管理处的人没有给未核验姓名胸牌，也没有说“你现在是工作人员”。他们只把铁皮章盒推近一点，说当前号票关联的材料没人整理，窗口就不能继续叫号。队伍听见的是另一种意思：站在桌前的人应该能给出结果。

{protagonist_name}胸前的卡套里还是那张“补办人”临时条。它不能证明身份，只能证明这个编号已经被系统盯上。抱着老人等通行条的家属、不敢离开床位表的志愿者、只拿着空碗的孩子，都开始把目光递过来。

林小满站在便利店纸箱旁，熟客名单夹在胳膊下。她没有像窗口工作人员那样喊号，只低声提醒{protagonist_name}：这里每张表都会把人写进去，也可能把人写没。她的手指一直压着刚刚空掉的那一行。

第一张号票还在取号机口轻轻抖动。排队管理处退到胶带线后面；林小满的名单压住一角；章盒又自己往前滑了半寸。{protagonist_name}没有获得权力，只是被推到了责任最容易落下来的位置。现在能先看的地方很清楚：林小满、队伍、取号机、窗口桌面、熟客名单、手续边界。先碰哪一处，周婶、通行条和补办编号都会跟着动。
