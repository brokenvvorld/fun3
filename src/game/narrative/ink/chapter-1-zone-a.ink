...
长昼把临时避难点晒得发白。社区服务大厅外借来的折叠桌排成一排，桌面上有配给回执、空白值班表、临时通行条复印申请和几箱从便利店搬来的临期酸奶。排队管理处的人只把铁皮章盒推给{protagonist_name}，说一号窗口缺一个能把手续办完的人。

{protagonist_name}胸前的卡套里还是那张“补办人”临时条。它不能证明身份，却能让等待的人把申请递过来。队伍里有抱着老人等通行条的家属，有不敢离开床位表的志愿者，也有只拿着空碗的孩子。

林小满站在便利店纸箱旁，熟客名单夹在胳膊下。她没有像窗口工作人员那样喊号，只低声提醒{protagonist_name}：这里每张表都会把人写进去，也可能把人写没。

第一张号票还在取号机口轻轻抖动，排队管理处已经退到胶带线后面；林小满的名单压住一角，窗口桌面上的章盒又自己往前滑了半寸。三件事同时催促{protagonist_name}：先稳住窗口，先保住活人名单，或者先问清这只被推来的章盒到底允许做什么。
...
* [接手桌面：清出一号窗口，把回执、申请和空白表分开]
    ...
    {protagonist_name}把回执和空白表分成三摞。最下面那摞纸自己往盖章机方向滑了一寸，像已经知道谁会先被处理。
