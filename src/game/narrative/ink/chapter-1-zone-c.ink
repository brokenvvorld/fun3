...
// TEST_STUB_KEEP: 旧片区 C 框架测试桩，用于验证不可逆分支、第一章归档回响、图鉴处置和跨章兼容入口。
...
# choice:0:group=document
# choice:0:target=fire_door_order
# choice:0:label=维修单
# choice:0:mode=compare
# choice:0:surface=modal
# choice:0:repeatable=true
# choice:1:group=document
# choice:1:target=fire_door_order
# choice:1:label=责任说明
...
# choice:3:target=archive_cabinet
# choice:3:label=档案柜
# choice:3:mode=inspect
# choice:3:surface=modal
# choice:3:repeatable=true
# choice:4:group=place
# choice:4:target=fire_door
# choice:4:label=消防门水流
# choice:4:mode=inspect
# choice:4:surface=modal
# choice:4:repeatable=true
# choice:5:group=document
# choice:5:target=fire_door_order
# choice:5:label=老王楼栋便签
# choice:5:mode=operate
# choice:5:surface=modal
# choice:5:repeatable=true
# choice:6:group=document
# choice:6:target=fire_door_order
# choice:6:label=幸存者便签
# choice:6:mode=operate
# choice:6:surface=modal
# choice:6:repeatable=true
# choice:7:group=person
# choice:7:target=lin_xiaoman
# choice:7:label=便利店记忆
# choice:7:mode=talk
# choice:7:surface=modal
# choice:7:repeatable=true
# choice:8:group=document
# choice:8:target=fire_door_order
# choice:8:label=印章水印
# choice:8:mode=inspect
# choice:8:surface=modal
# choice:8:repeatable=true
# choice:9:group=decision
# choice:9:target=fire_door_order
# choice:9:label=签字环节
# choice:9:mode=advance
# choice:9:surface=next_step
# choice:9:repeatable=false
...
# choice:2:repeatable=true
# choice:3:group=place
# choice:3:target=drain_cover
# choice:3:label=井盖刻痕
# choice:3:mode=inspect
# choice:3:surface=modal
# choice:3:repeatable=true
# choice:4:group=place
# choice:4:target=drain_well
# choice:4:label=排水井
# choice:4:mode=inspect
# choice:4:surface=modal
# choice:4:repeatable=true
# choice:5:group=document
# choice:5:target=drain_receipt
# choice:5:label=自愿承担
# choice:5:mode=inspect
# choice:5:surface=modal
# choice:5:repeatable=true
# choice:6:group=document
# choice:6:target=route_marker
# choice:6:label=地下路线标记
# choice:6:mode=inspect
# choice:6:surface=modal
# choice:6:repeatable=true
# choice:7:group=person
# choice:7:target=lin_xiaoman
...
# choice:7:surface=modal
# choice:7:repeatable=true
# choice:8:group=decision
# choice:8:target=drain_receipt
# choice:8:label=确认回执
# choice:8:mode=advance
# choice:8:surface=next_step
# choice:8:repeatable=false
...
# choice:0:repeatable=true
# choice:1:group=document
# choice:1:target=customer_list
# choice:1:label=名单缺页
# choice:1:mode=compare
# choice:1:surface=modal
# choice:1:repeatable=true
# choice:2:group=document
# choice:2:target=archive_cabinet
# choice:2:label=户籍柜
# choice:2:mode=inspect
# choice:2:surface=modal
# choice:2:repeatable=true
# choice:3:group=document
# choice:3:target=receipt
# choice:3:label=便利店小票
# choice:3:mode=operate
# choice:3:surface=modal
# choice:3:repeatable=true
# choice:4:group=person
# choice:4:target=lin_xiaoman
# choice:4:label=被裁走的名字
# choice:4:mode=talk
# choice:4:surface=modal
# choice:4:repeatable=true
# choice:5:group=document
# choice:5:target=customer_list
# choice:5:label=消防门结果
# choice:5:mode=compare
# choice:5:surface=modal
# choice:5:repeatable=true
# choice:6:group=document
# choice:6:target=drain_receipt
# choice:6:label=排水井回执
# choice:6:mode=compare
# choice:6:surface=modal
# choice:6:repeatable=true
# choice:7:group=person
# choice:7:target=lin_xiaoman
...
# choice:7:repeatable=true
# choice:8:group=document
# choice:8:target=customer_list
# choice:8:label=压住的字
# choice:8:mode=inspect
# choice:8:surface=modal
# choice:8:repeatable=true
# choice:9:group=decision
# choice:9:target=customer_list
# choice:9:label=处理缺页
# choice:9:mode=advance
# choice:9:surface=next_step
# choice:9:repeatable=false
...
# choice:0:target=core_leak
# choice:0:label=维护盒编号
# choice:0:mode=inspect
# choice:0:surface=modal
# choice:0:repeatable=true
# choice:1:group=person
...
# choice:1:repeatable=true
# choice:2:group=place
# choice:2:target=archive_exit
# choice:2:label=门外人群
# choice:2:mode=talk
# choice:2:surface=modal
# choice:2:repeatable=true
# choice:3:group=machine
# choice:3:target=core_leak
# choice:3:label=排水井连接
# choice:3:mode=inspect
# choice:3:surface=modal
# choice:3:repeatable=true
# choice:4:group=document
# choice:4:target=fire_door_order
# choice:4:label=消防门维修单
# choice:4:mode=compare
# choice:4:surface=modal
# choice:4:repeatable=true
# choice:5:group=document
# choice:5:target=customer_list
# choice:5:label=熟客名单缺页
# choice:5:mode=compare
# choice:5:surface=modal
# choice:5:repeatable=true
# choice:6:group=document
...
# choice:6:surface=modal
# choice:6:repeatable=true
# choice:7:group=machine
# choice:7:target=municipal_echo
# choice:7:label=市政回声
# choice:7:mode=inspect
# choice:7:surface=modal
# choice:7:repeatable=true
# choice:8:group=decision
# choice:8:target=core_leak
# choice:8:label=处置渗水点
# choice:8:mode=advance
# choice:8:surface=next_step
# choice:8:repeatable=false
